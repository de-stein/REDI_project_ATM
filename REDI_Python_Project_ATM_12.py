...
while trying != 0:
    ...
    if (data_input not in account):                # <-- while loop checks that account number and pin are correct and match. 
        ...
        if user_choise == 'd':
            deposit = int(input('Enter the Amount, put the money and press Enter ')) # <-- customer enters how much money to deposit
            ...
            withdraw = int(input('Enter the Amount: '))  # <-- customer enters how much money to withdraw
